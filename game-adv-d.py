...
def joga():
    ...
    for i,v in enumerate(t):
        ...
        # JOGO NA VERTICAL #
    if t[0]==2 and t[3]==2 and t[6]==0:
        t[6]=2
    elif t[0]==2 and t[6]==2 and t[3]==0:
        t[3]=2
    elif t[6]==2 and t[3]==2 and t[0]==0:
        t[0]=2

    elif t[1]==2 and t[4]==2 and t[7]==0:
        t[7]=2
    elif t[1]==2 and t[7]==2 and t[4]==0:
        t[4]=2
    elif t[7]==2 and t[4]==2 and t[1]==0:
        t[1]=2

    elif t[2]==2 and t[5]==2 and t[8]==0:
        t[8]=2
    elif t[2]==2 and t[8]==2 and t[5]==0:
        t[5]=2
    elif t[8]==2 and t[5]==2 and t[2]==0:
        t[2]=2
         # JOGO HORIZONTAL #
    elif t[0]==2 and t[1]==2 and t[2]==0:
        t[2]=2
    elif t[1]==2 and t[2]==2 and t[0]==0:
        t[0]=2
    elif t[0]==2 and t[2]==2 and t[1]==0:
        t[1]=2    

    elif (t[3]==2 and t[4]==2) and t[5]==0:
        t[5]=2
    elif (t[3]==2 and t[5]==2) and t[4]==0:
        t[4]=2
    elif (t[5]==2 and t[4]==2) and t[3]==0:
        t[3]=2
        
    elif (t[6]==2 and t[7]==2) and t[8]==0:
        t[8]=2
    elif (t[6]==2 and t[8]==2) and t[7]==0:
        t[7]=2
    elif (t[8]==2 and t[7]==2) and t[6]==0:
        t[6]=2
        
      # VERIFICA DIAGONAL #
    elif (t[0]==1 and t[4]==1) and t[8]==0:
        t[8]=2
